...
type SecurityConfig struct {
	...
	// TrustedProxies lists the IPs (RemoteAddr, no port) of proxies/load
	// balancers allowed to set X-Forwarded-For / X-Real-IP. If empty, those
	// headers are ignored entirely and RemoteAddr is used directly, since
	// any client can set them and they must not be trusted by default.
